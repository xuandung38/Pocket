...
| 02 | [Camera Screen Redesign — Rounded Square + FriendMomentRow](./phase-02-camera-screen-redesign-rounded-square-friendmomentrow.md) | 4h | pending | — |
| 03 | [Feed Screen Redesign — Fullscreen Scroll-Snap Swiper](./phase-03-feed-screen-redesign-fullscreen-scroll-snap-swiper.md) | 3h | pending | — |
| 04 | [Bug Fixes — SocketContext + FriendStore + ChatDetail Safe-Area](./phase-04-bug-fixes-socketcontext-friendstore-chatdetail-safe-area.md) | 3h | pending | — |
